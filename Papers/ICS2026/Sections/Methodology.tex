\section{Methodology}
In this section we highlight the underlying methodology and steps involved in this paper. The entire methodology can be broadly classified into three phases as shown in the figure \ref{ch5:fig:flow-diagram}, namely: i) Data collection, ii) Training and iii) Testing/ evaluation.
